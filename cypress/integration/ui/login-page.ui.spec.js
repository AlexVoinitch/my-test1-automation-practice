describe('LoginPage: Given valid and invalid user credentials are available', { testIsolation: false }, function () {
  ...
  context('LoginPage.INVALID_USER: When logging in with invalid username', () => {
    it.skip('LoginPage.INVALID_USER: Then error is shown for invalid credentials', () => {
      // ... (Not implemented yet)
    });
  });

  context('LoginPage.INVALID_PASSWORD: When logging in with invalid password', () => {
    it.skip('LoginPage.INVALID_PASSWORD: Then error is shown for invalid credentials', () => {
      // ... (Not implemented yet)
    });
  });

  context('LoginPage.LOCKED_OUT_USER: When logging in as a locked user', () => {
    it.skip('LoginPage.LOCKED_OUT_USER: Then error is shown for locked user', () => {
      // ... (Not implemented yet)
    });
  });

  context('LoginPage.EMPTY_FIELDS: When logging in with empty fields', function () {
